...
geom_histogram(binwidth=3) #the type of plot we want to make
```
...
It seems that lower body mass is associated with greater bill depth and smaller flipper lengths while higher body mass is associated with smaller bill depth and longer flipper length.

```{r}
ggplot(penguins, aes(x=bill_depth_mm, y = flipper_length_mm, color = body_mass_g)) +
  geom_point()
